  ...
  return createPortal(
    <div className="bg-white rounded-lg shadow-lg">
      ...
      <button
        ...
        className="flex items-center gap-2 p-2 lg:px-3 lg:py-2 hover:bg-gray-100 rounded-lg transition-colors"
        title={`Map: ${currentLayer.name}`}
      >
        ...
        <svg className={`hidden lg:block w-4 h-4 text-gray-400 transition-transform ${isOpen ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {/* Dropdown menu */}
      {isOpen && (
        <div className="absolute top-full right-0 mt-1 w-48 lg:w-64 max-h-80 overflow-y-auto bg-white rounded-lg shadow-xl border border-gray-200">
